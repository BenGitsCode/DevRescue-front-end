...
/***/ function(module, exports, __webpack_require__) {
	...
	var newRescue = function newRescue(success, failure, data) {
	  $.ajax({
	    method: "POST",
	...
	//Update Rescue
	var editRescue = function editRescue(success, failure, data, id) {
	...
	//DELETE Rescue
	var deleteRescue = function deleteRescue(success, failure, data, id) {
	  console.log(data, id);
	  $.ajax({
	    method: 'DELETE',
	    url: app.api + '/rescues/' + id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showRescues = function showRescues() {
	  $.ajax({
	    method: "GET",
	...
	var deleteRescueSuccess = function deleteRescueSuccess(data) {
	...
	module.exports = {
	  ...
	  showRescues: showRescues,
	  editRescueSuccess: editRescueSuccess,
	  deleteRescueSuccess: deleteRescueSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"show-rescue\">\n  "
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "\n  <td class=\"rescue-title\">"
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</td>\n  <td class=\"rescue-url\"><a target=\"_blank\" href=\""
	    + alias2(alias1((depth0 != null ? depth0.url : depth0), depth0))
	    + "\">Rescue Me</a></td>\n  <td class=\"rescue-tag\">"
	    + alias2(alias1((depth0 != null ? depth0.tag : depth0), depth0))
	    + "</td>\n  <td><button type=\"button\"  class=\"btn btn-primary edit-rescue\" data-rescue-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#NOTedit-rescue-modal\">Update</button></td>\n  <td><button type=\"button\"  class=\"btn btn-danger delete-rescue\" data-rescue-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#delete-rescue-modal\">Delete</button></td>\n    </div>\n</tr>\n";
	  ...
	  return "<tr class=\"table-top-row\">\n  <td><b>title</b></td>\n  <td><b>Rescue Link</b></td>\n</tr>\n<tr class=\"table-top-row\">\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.rescues : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.rescueUrl : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
